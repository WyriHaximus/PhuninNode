...
class Plugins implements \WyriHaximus\PhuninNode\Interfaces\Plugin {
    ...
    private function getPluginCountValue() {
        if (isset($this->values['plugins_count']) && $this->values['plugins_count'] instanceof \WyriHaximus\PhuninNode\Value) {
    ...
    private function getPluginCategoryCountValue() {
        if (isset($this->values['plugins_category_count']) && $this->values['plugins_category_count'] instanceof \WyriHaximus\PhuninNode\Value) {
