...
abstract class AbstractConnectionContextTest extends \PHPUnit_Framework_TestCase {
    ...
    public function setUp() {
        ...
        $this->node = new \WyriHaximus\PhuninNode\Node($this->loop, 63168, '127.0.0.1');
        $this->node->addPlugin(new \WyriHaximus\PhuninNode\Plugins\Plugins());
        $this->node->addPlugin(new \WyriHaximus\PhuninNode\Plugins\PluginsCategories());
        $this->node->addPlugin(new \WyriHaximus\PhuninNode\Plugins\MemoryUsage());
